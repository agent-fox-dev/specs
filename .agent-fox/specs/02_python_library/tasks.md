...
- [ ] 2. Implement data models and exceptions
  - [ ] 2.1 Create package structure and exceptions module
  ...
  - [ ] 2.2 Implement PRD and Requirements data models
  ...
  - [ ] 2.3 Implement EARS discriminated union
  ...
  - [ ] 2.4 Implement TestSpec, Tasks, and SubtaskState
  ...
  - [ ] 2.V Verify task group 2
    - [ ] Spec tests for this group pass: `uv run pytest -q afspec/tests/test_models.py`
    - [ ] Edge case tests TS-02-E1, TS-02-E2 pass
    - [ ] Property tests TS-02-P2, TS-02-P3 pass
    - [ ] All existing tests still pass: `uv run pytest -q`
    - [ ] No linter warnings: `uv run ruff check`
    - [ ] Type check passes: `uv run mypy afspec/`
    - [ ] Requirements 02-REQ-1.1 through 02-REQ-1.5, 02-REQ-1.E1, 02-REQ-1.E2 acceptance criteria met
