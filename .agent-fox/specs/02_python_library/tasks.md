...
- [x] 11. Implement bootstrap mode and discovery
  - [x] 11.1 Implement BootstrapSpec context manager
  ...
  - [x] 11.2 Implement spec discovery
  ...
  - [x] 11.3 Wire public API in __init__.py
  ...
  - [x] 11.V Verify task group 11
    - [x] Spec tests for this group pass: `uv run pytest -q afspec/tests/test_bootstrap.py afspec/tests/test_discovery.py`
    - [x] Edge case tests TS-02-E12 through TS-02-E15, TS-02-E18 through TS-02-E20 pass
    - [x] All existing tests still pass: `uv run pytest -q`
    - [x] No linter warnings: `uv run ruff check`
    - [x] Type check passes: `uv run mypy afspec/`
    - [x] Requirements 02-REQ-8.1 through 02-REQ-8.4, 02-REQ-8.E1 through 02-REQ-8.E3, 02-REQ-9.1 through 02-REQ-9.5, 02-REQ-9.E1 through 02-REQ-9.E3 acceptance criteria met
